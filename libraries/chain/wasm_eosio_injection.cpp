...
#include <eotio/chain/wasm_eotio_binary_ops.hpp>
...
namespace eotio { namespace chain { namespace wasm_injections {
using namespace IR;
using namespace eotio::chain::wasm_constraints;
...
}}} // namespace eotio, chain, injectors
