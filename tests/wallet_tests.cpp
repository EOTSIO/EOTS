...
#include <eotio/wallet_plugin/wallet.hpp>
#include <eotio/wallet_plugin/wallet_manager.hpp>
...
{ try {
   using namespace eotio::wallet;
   using namespace eotio::utilities;
...
{ try {
   ...
   constexpr auto key3 = "5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3"; // eotio key
   ...
   // eotio key is imported automatically when a wallet is created
