...
#include <eotio/chain/contract_table_objects.hpp>
#include <eotio/chain/global_property_object.hpp>
#include <eotio/chain/resource_limits.hpp>
#include <eotio/chain/wast_to_wasm.hpp>

#include <Runtime/Runtime.h>

#include "eotio_system_tester.hpp"

using namespace eotio_system;

BOOST_AUTO_TEST_SUITE(eotio_system_tests)

BOOST_FIXTURE_TEST_CASE( buysell, eotio_system_tester ) try {

   BOOST_REQUIRE_EQUAL( core_from_string("1000000000.0000"), get_balance( "eotio" ) );
   BOOST_REQUIRE_EQUAL( core_from_string("0.0000"), get_balance( "alice1111111" ) );

   transfer( "eotio", "alice1111111", core_from_string("1000.0000"), "eotio" );
   BOOST_REQUIRE_EQUAL( success(), stake( "eotio", "alice1111111", core_from_string("200.0000"), core_from_string("100.0000") ) );
   ...
   transfer( "eotio", "alice1111111", core_from_string("100000000.0000"), "eotio" );
...
BOOST_FIXTURE_TEST_CASE( stake_unstake, eotio_system_tester ) try {
   //issue( "eotio", core_from_string("1000.0000"), config::system_account_name );

   BOOST_REQUIRE_EQUAL( core_from_string("1000000000.0000"), get_balance( "eotio" ) );
   BOOST_REQUIRE_EQUAL( core_from_string("0.0000"), get_balance( "alice1111111" ) );
   transfer( "eotio", "alice1111111", core_from_string("1000.0000"), "eotio" );
   BOOST_REQUIRE_EQUAL( core_from_string("999999000.0000"), get_balance( "eotio" ) );
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_with_transfer, eotio_system_tester ) try {
   //issue( "eotio", core_from_string("1000.0000"), config::system_account_name );
   BOOST_REQUIRE_EQUAL( core_from_string("1000000000.0000"), get_balance( "eotio" ) );
   BOOST_REQUIRE_EQUAL( core_from_string("0.0000"), get_balance( "alice1111111" ) );

   //eotio stakes for alice with transfer flag
   BOOST_REQUIRE_EQUAL( success(), stake_with_transfer( "eotio", "alice1111111", core_from_string("200.0000"), core_from_string("100.0000") ) );
   ...
   //BOOST_REQUIRE_EQUAL( core_from_string("999999700.0000"), get_balance( "eotio" ) );
   BOOST_REQUIRE_EQUAL( core_from_string("0.0000"), get_balance( "alice1111111" ) );

   //alice stakes for herself
   transfer( "eotio", "alice1111111", core_from_string("1000.0000"), "eotio" );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "alice1111111", core_from_string("200.0000"), core_from_string("100.0000") ) );
   //now alice's stake should be equal to transfered from eotio + own stake
   total = get_total_stake("alice1111111");
   BOOST_REQUIRE_EQUAL( core_from_string("700.0000"), get_balance( "alice1111111" ) );
...
BOOST_FIXTURE_TEST_CASE( fail_without_auth, eotio_system_tester ) try {
   issue( "alice1111111", core_from_string("1000.0000"),  config::system_account_name );

   BOOST_REQUIRE_EQUAL( success(), stake( "eotio", "alice1111111", core_from_string("2000.0000"), core_from_string("1000.0000") ) );
...
BOOST_FIXTURE_TEST_CASE( stake_negative, eotio_system_tester ) try {
   issue( "alice1111111", core_from_string("1000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( unstake_negative, eotio_system_tester ) try {
   issue( "alice1111111", core_from_string("1000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( unstake_more_than_at_stake, eotio_system_tester ) try {
   issue( "alice1111111", core_from_string("1000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( delegate_to_another_user, eotio_system_tester ) try {
   issue( "alice1111111", core_from_string("1000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_separate, eotio_system_tester ) try {
   issue( "alice1111111", core_from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( core_from_string("1000.0000"), get_balance( "alice1111111" ) );
...
BOOST_FIXTURE_TEST_CASE( adding_stake_partial_unstake, eotio_system_tester ) try {
   issue( "alice1111111", core_from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "bob111111111", core_from_string("200.0000"), core_from_string("100.0000") ) );
...
BOOST_FIXTURE_TEST_CASE( stake_from_refund, eotio_system_tester ) try {
   issue( "alice1111111", core_from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "bob111111111", core_from_string("200.0000"), core_from_string("100.0000") ) );
...
// Tests for voting
BOOST_FIXTURE_TEST_CASE( producer_register_unregister, eotio_system_tester ) try {
   issue( "alice1111111", core_from_string("1000.0000"),  config::system_account_name );

   fc::variant params = producer_parameters_example(1);
   auto key =  fc::crypto::public_key( std::string("eot6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV") );
...
BOOST_FIXTURE_TEST_CASE( vote_for_producer, eotio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   issue( "alice1111111", core_from_string("1000.0000"),  config::system_account_name );
   fc::variant params = producer_parameters_example(1);
   BOOST_REQUIRE_EQUAL( success(), push_action( N(alice1111111), N(regproducer), mvo()
                                               ("producer",  "alice1111111")
...
BOOST_FIXTURE_TEST_CASE( unregistered_producer_voting, eotio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   issue( "bob111111111", core_from_string("2000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( more_than_30_producer_voting, eotio_system_tester ) try {
   issue( "bob111111111", core_from_string("2000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", core_from_string("13.0000"), core_from_string("0.5791") ) );
   REQUIRE_MATCHING_OBJECT( voter( "bob111111111", core_from_string("13.5791") ), get_voter_info( "bob111111111" ) );
...
BOOST_FIXTURE_TEST_CASE( vote_same_producer_30_times, eotio_system_tester ) try {
   issue( "bob111111111", core_from_string("2000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( producer_keep_votes, eotio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   issue( "alice1111111", core_from_string("1000.0000"),  config::system_account_name );
   fc::variant params = producer_parameters_example(1);
...
BOOST_FIXTURE_TEST_CASE( vote_for_two_producers, eotio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   //alice1111111 becomes a producer
   fc::variant params = producer_parameters_example(1);
...
BOOST_FIXTURE_TEST_CASE( proxy_register_unregister_keeps_stake, eotio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( proxy_stake_unstake_keeps_proxy_flag, eotio_system_tester ) try {
   BOOST_REQUIRE_EQUAL( success(), push_action( N(alice1111111), N(regproxy), mvo()
                                               ("proxy",  "alice1111111")
                                               ("isproxy", true)
                        )
...
BOOST_FIXTURE_TEST_CASE( proxy_actions_affect_producers, eotio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
...
BOOST_FIXTURE_TEST_CASE(producer_pay, eotio_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(multiple_producer_pay, eotio_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(producers_upgrade_system_contract, eotio_system_tester) try {
   //install multisig contract
   abi_serializer msig_abi_ser;
   {
      create_account_with_resources( N(eotio.msig), config::system_account_name );
      BOOST_REQUIRE_EQUAL( success(), buyram( "eotio", "eotio.msig", core_from_string("5000.0000") ) );
      produce_block();
      ...
      set_code( N(eotio.msig), eotio_msig_wast );
      set_abi( N(eotio.msig), eotio_msig_abi );

      produce_blocks();
      const auto& accnt = control->db().get<account_object,by_name>( N(eotio.msig) );
      abi_def msig_abi;
   ...
   auto trace_auth = TESTER::push_action(config::system_account_name, updateauth::get_name(), config::system_account_name, mvo()
                                         ...
                                         ("auth",  authority(1, {key_weight{get_public_key( config::system_account_name, "active" ), 1}}, {
                                               permission_level_weight{{config::system_account_name, config::eotio_code_name}, 1},
   ...
   string eotio_system_wast2 = eotio_system_wast;
   string msg = "producer votes must be unique and sorted";
   auto pos = eotio_system_wast2.find(msg);
   BOOST_REQUIRE( pos != std::string::npos );
   msg[0] = 'P';
   eotio_system_wast2.replace( pos, msg.size(), msg );

   transaction trx;
   {
      auto code = wast_to_wasm( eotio_system_wast2 );
...
BOOST_FIXTURE_TEST_CASE(producer_onblock_check, eotio_system_tester) try {
...
BOOST_FIXTURE_TEST_CASE( voters_actions_affect_proxy_and_producers, eotio_system_tester, * boost::unit_test::tolerance(1e+6) ) try {
...
BOOST_FIXTURE_TEST_CASE( vote_both_proxy_and_producers, eotio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( select_invalid_proxy, eotio_system_tester ) try {
   //accumulate proxied votes
   issue( "bob111111111", core_from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", core_from_string("100.0002"), core_from_string("50.0001") ) );
...
BOOST_FIXTURE_TEST_CASE( double_register_unregister_proxy_keeps_votes, eotio_system_tester ) try {
   //alice1111111 becomes a proxy
   BOOST_REQUIRE_EQUAL( success(), push_action( N(alice1111111), N(regproxy), mvo()
                                                ("proxy",  "alice1111111")
                                                ("isproxy",  1)
...
BOOST_FIXTURE_TEST_CASE( proxy_cannot_use_another_proxy, eotio_system_tester ) try {
   //alice1111111 becomes a proxy
   BOOST_REQUIRE_EQUAL( success(), push_action( N(alice1111111), N(regproxy), mvo()
                                                ("proxy",  "alice1111111")
                                                ("isproxy",  1)
...
fc::mutable_variant_object config_to_variant( const eotio::chain::chain_config& config ) {
...
BOOST_FIXTURE_TEST_CASE( elect_producers /*_and_parameters*/, eotio_system_tester ) try {
   create_accounts_with_resources( {  N(defproducer1), N(defproducer2), N(defproducer3) } );
   BOOST_REQUIRE_EQUAL( success(), regproducer( "defproducer1", 1) );
   BOOST_REQUIRE_EQUAL( success(), regproducer( "defproducer2", 2) );
   BOOST_REQUIRE_EQUAL( success(), regproducer( "defproducer3", 3) );
...
BOOST_FIXTURE_TEST_CASE( buyname, eotio_system_tester ) try {
   ...
   transfer( "eotio", "nofail", core_from_string( "1000.0000" ) );
...
BOOST_FIXTURE_TEST_CASE( multiple_namebids, eotio_system_tester ) try {
