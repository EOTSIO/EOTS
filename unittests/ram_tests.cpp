 ...
 * ram_tests test case
 *************************************************************************************/
BOOST_FIXTURE_TEST_CASE(ram_tests, eotio_system::eotio_system_tester) { try {
   ...
   buyrambytes(N(eotio), N(eotio), 70000);
   produce_blocks(10);
   create_account_with_resources(N(testram11111),N(eotio), init_request_bytes);
   create_account_with_resources(N(testram22222),N(eotio), init_request_bytes);
   produce_blocks(10);
   BOOST_REQUIRE_EQUAL( success(), stake( "eotio", "testram11111", core_from_string("10.0000"), core_from_string("5.0000") ) );
   produce_blocks(10);
   ...
   for (auto i = 0; i < 10; ++i) {
      try {
         ...
         buyrambytes(N(eotio), N(testram11111), increment_contract_bytes);
         buyrambytes(N(eotio), N(testram22222), increment_contract_bytes);
      }
   }
   produce_blocks(10);
   ...
   buyrambytes(N(eotio), N(testram11111), more_ram);
   buyrambytes(N(eotio), N(testram22222), more_ram);
