...
#ifdef DISABLE_eotLIB_SERIALIZE
#include <eotiolib/serialize.hpp>
#undef eotLIB_SERIALIZE
#define eotLIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  eotLIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   eotLIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   eotLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   eotLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
