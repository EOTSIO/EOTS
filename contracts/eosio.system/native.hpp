...
namespace eotiosystem {
   ...
   struct permission_level_weight {
      ...
      eotLIB_SERIALIZE( permission_level_weight, (permission)(weight) )
   };
   ...
   struct key_weight {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      eotLIB_SERIALIZE( key_weight, (key)(weight) )
   };
   ...
   struct authority {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      eotLIB_SERIALIZE( authority, (threshold)(delay_sec)(keys)(accounts) )
   };
   ...
   struct block_header {
      ...
      eotio::optional<eotio::producer_schedule> new_producers;

      // explicit serialization macro is not necessary, used here only to improve compilation time
      eotLIB_SERIALIZE(block_header, (timestamp)(producer)(confirmed)(previous)(transaction_mroot)(action_mroot)
    ...
    */
   class native : public eotio::contract {
      public:

         using eotio::contract::contract;
