...
## eotio.system::cfgproducer    account config
...
## eotio.system::okproducer     account producer vote
...
## eotio.system::setproxy       account proxy
...
## eotio.system::unstake        account quantity 
...
## eotio.system::withdraw account
   - this action can only be triggered by eotio.system via a deferred transaction generated by unstake
   - this will generate an inline eotio.token::transfer call from=eotio.system to=account and amount equal to the next withdraw increment
   - this will generate another deferred withdraw to continue the process if there are still withdraws to be made


## eotio.system::transfer from to amount memo
   - decrements balance of from if amount <= balance
   - increments balance of to by amount
   - memo is ignored 

## eotio.system::stakevote account amount
   - the primary currency of eotio is controlled by the token contract which enables users to transfer
...
## eotio.system::onblock   account blocktime blocknum
...
## eotio.system::freeze producer accounts true|false 
...
## eotio.system::paystandby producer
