#pragma once
#include <eotiolib/core_symbol.hpp>
...
namespace eotio {
   ...
   #define S(P,X) ::eotio::string_to_symbol(P,#X)
   ...
   struct symbol_type {
      ...
      eotLIB_SERIALIZE( symbol_type, (value) )
   };
   ...
   struct extended_symbol : public symbol_type
   {
      ...
      eotLIB_SERIALIZE( extended_symbol, (value)(contract) )
   };
