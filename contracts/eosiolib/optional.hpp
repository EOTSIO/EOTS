...
namespace eotio {
   ...
   class optional {
      public:
         ...
         T&       operator*()      { eotio_assert(_valid, "dereference of empty optional"); return ref(); }
         const T& operator*()const { eotio_assert(_valid, "dereference of empty optional"); return ref(); }

         T*       operator->()
         {
            eotio_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         friend inline eotio::datastream<Stream>& operator>> (eotio::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         template<typename Stream>
         friend inline eotio::datastream<Stream>& operator<< (eotio::datastream<Stream>& ds, const optional& op)
         {
