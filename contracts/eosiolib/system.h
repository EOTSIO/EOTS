...
extern "C" {
    ...
    */
   void  eotio_assert( uint32_t test, const char* msg );
    ...
    */
   void  eotio_assert_message( uint32_t test, const char* msg, uint32_t msg_len );
    ...
    */
   void  eotio_assert_code( uint32_t test, uint64_t code );
    ...
    */
   [[noreturn]] void  eotio_exit( int32_t code );
