...
namespace eotio {
   ...
   struct margin_state {
      ...
      extended_asset unlend( double ishares ) {
         ...
         eotio_assert( interest_shares >= 0, "underflow" );
         eotio_assert( total_lendable.amount >= 0, "underflow" );

         return result;
      }

      eotLIB_SERIALIZE( margin_state, (total_lendable)(total_lent)(least_collateralized)(interest_shares) )
   };
   ...
   struct exchange_state {
      ...
      struct connector {
         ...
         eotLIB_SERIALIZE( connector, (balance)(weight)(peer_margin) )
      };
      ...
      eotLIB_SERIALIZE( exchange_state, (manager)(supply)(fee)(base)(quote) )
   };

   typedef eotio::multi_index<N(markets), exchange_state> markets;
