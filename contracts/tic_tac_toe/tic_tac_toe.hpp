...
namespace tic_tac_toe {
   ...
   struct game {
      ...
      eotLIB_SERIALIZE( game, (challenger)(host)(turn)(winner)(board) )
   };
   ...
   struct create {
      ...
      eotLIB_SERIALIZE( create, (challenger)(host) )
   };
   ...
   struct restart {
      ...
      eotLIB_SERIALIZE( restart, (challenger)(host)(by) )
   };
   ...
   struct close {
      ...
      eotLIB_SERIALIZE( close, (challenger)(host) )
   };
   ...
   struct movement {
      ...
      eotLIB_SERIALIZE( movement, (row)(column) )
   };
   ...
   struct move {
      ...
      eotLIB_SERIALIZE( move, (challenger)(host)(by)(mvt) )
   };

   /**
    * @brief table definition, used to store existing games and their current state
    */
   typedef eotio::multi_index< games_account, game> games;
}
/// @}
